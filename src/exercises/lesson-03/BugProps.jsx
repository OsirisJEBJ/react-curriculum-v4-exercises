...
// Explanation:
// The issue was that the message was stored in a normal variable.
// React doesn’t re-render when a regular variable changes.
// Using useState makes the message update on screen.
